...
Vue.component('mi-input-date-hour', {
  props: {
    placeholder: {
      type: String,
  ...
  template: `<div class="mi-input-date-hour">
    <div class="display_table width_100">
      ...
      <div class="display_table_cell">
        <mi-button class="blanco" :on-click="alternar_selector">{{ $t("Seleccionar fecha y hora") }}</mi-button>
      </div>
    </div>
    <div v-show="esta_mostrando_selector" class="pad_1">
      <vuejs-calendario mode="datetime" :on-change="v => inputValue = v" :initial-value="inputValue" />
    </div>
  </div>`,
  data: function() {
    return {
