    ...
    class SistemaDeComunicaciones {
        ...
        static ajax(method, url, data = null, headers = {}) {
            return new Promise((resolve, reject) => {
                ...
                for (const [header, value] of Object.entries(Object.assign({}, this.constructor.headers_por_defecto, headers))) {
                ...
                const final_data = typeof data === "object" ? JSON.stringify(data) : data;
